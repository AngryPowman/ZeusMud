...
namespace zeus_mud.dialog
{
    public partial class frmBattle : Form
    {
        private void initGame()
        {
            ...
            picCard4.Image = imgsCard.Images[3];

            picECard1.Image = imgsCard.Images[0];
            picECard2.Image = imgsCard.Images[1];
            picECard3.Image = imgsCard.Images[2];
            picECard4.Image = imgsCard.Images[3];
        }
        int theFourth = -1;
        int[] ACard = { -1, -1, -1, -1 };
        ...
        private void picCard4_Click(object sender, EventArgs e)
        {
            switch (btnIndex)
            {
                case 0:
                    ...
                    if (theFourth > 2)
                        theFourth = 0;
                    picCard4.Image = imgsCard.Images[theFourth];
                    break;
                case 2:
                case 3:
                case 4:
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            switch (btnIndex)
            {
                case 0:
                    ...
                    picECard4.Image = imgsCard.Images[ACardset[3]];
                ...
                case 1:
                    setCards();
                    picECard1.Image = imgsCard.Images[3];
                    picECard2.Image = imgsCard.Images[3];
                    picECard3.Image = imgsCard.Images[3];
                    picECard4.Image = imgsCard.Images[3];
                ...
                case 2:
                    fight();
                    picECard1.Image = imgsCard.Images[ACard[0]];
                    btnIndex++;
                    break;
                case 3:
                    fight();
                    picECard2.Image = imgsCard.Images[ACard[1]];
                    btnIndex++;
                    break;
                case 4:
                    fight();
                    picECard3.Image = imgsCard.Images[ACard[2]];
                    btnIndex++;
                    break;
                case 5:
                    fight();
                    picECard4.Image = imgsCard.Images[ACard[3]];
                    if (mPoint > APoint)
                        button1.Text = "胜利了！";
